...
CXX ?= g++
PROGRAM = forecast
CXXFILES = main.cc constants.cc mainapp.cc skeletonapplication.cc jsonparser.cc settings.cc cities.cc db.cc canvas.cc treeview_withpopup.cc forecastapi.cc history_viewer.cc log_chart.cc
